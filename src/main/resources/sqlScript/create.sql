...
CREATE TABLE `t_community` (
  ...
  `img_1` varchar(32)  DEFAULT NULL COMMENT '图片1',
  `img_2` varchar(32)  DEFAULT NULL COMMENT '图片2',
  `img_3` varchar(32)  DEFAULT NULL COMMENT '图片3',
  `img_4` varchar(32)  DEFAULT NULL COMMENT '图片4',
  `img_5` varchar(32)  DEFAULT NULL COMMENT '图片5',
  `is_online` char(1) NOT NULL,
