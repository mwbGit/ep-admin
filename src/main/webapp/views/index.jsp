...
<body class="page-header-fixed">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img src="${ctx }/static/media/image/avatar2.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="${ctx }/static/media/image/avatar3.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="${ctx }/static/media/image/avatar1.jpg" alt="" /></span>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<%-- todo <div id="portlet-config" class="modal hide">--%>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#" id="menuTitle">Dashboard</a></li>
