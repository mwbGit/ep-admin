    ...
    <div class="modal-body">
        ...
        <form method="post" class="form-horizontal" id="modifyTypeFrom">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn blue" onclick="modifyTypeNameBut()"><i class="icon-ok"></i> 提交
                </button>
    ...
    <div class="modal-body">
        ...
        <form method="post" class="form-horizontal" id="addFrom">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn blue" onclick="addTypeNameBut()"><i class="icon-ok"></i> 提交
                </button>
